...
RSpec.describe "Searching Github", type: :feature do
  ...
  it "displays the right data" do
    ...
    expect(page).to have_link("https://github.com/fridek/Threejs-Tetris", href: "https://github.com/fridek/Threejs-Tetris")
    expect(page).to have_content("Tetris")
    expect(page).to have_content("3D Tetris implementation in WebGL")
  end
end
